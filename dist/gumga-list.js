...
function List($compile, listCreator) {
  ...
  function controller($scope, $element, $attrs, $timeout) {
    ...
    ctrl.roundNumber = function (count, pageSize, pageModel) {
      var num = Math.floor(count / pageSize) * pageModel;
